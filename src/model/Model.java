...
public class Model {
	...
	public Shape makeTransformacoes(
		...
		//Transformação de escala
                transformacao.preConcatenate(AffineTransform.getTranslateInstance(-pontoCentral.x, -pontoCentral.y));
		transformacao.preConcatenate(AffineTransform.getScaleInstance(es.x, es.y));
		transformacao.preConcatenate(AffineTransform.getTranslateInstance(pontoCentral.x, pontoCentral.y));
                //Transformção se cisalhamento
                transformacao.preConcatenate(AffineTransform.getTranslateInstance(-pontoCentral.x, -pontoCentral.y));
		transformacao.preConcatenate(AffineTransform.getScaleInstance(c.x, c.y));
		transformacao.preConcatenate(AffineTransform.getTranslateInstance(pontoCentral.x, pontoCentral.y));
